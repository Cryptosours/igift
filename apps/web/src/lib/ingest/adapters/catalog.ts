...
const CATALOG: CatalogEntry[] = [
  ...
  // ── Best Buy (green zone, authorized retailer) ──
  {
    sourceSlug: "bestbuy",
    sourceName: "Best Buy",
    brandName: "Apple",
    ...
    denomination: "100",
    countries: ["US"],
    externalUrl: "https://www.bestbuy.com/site/apple-gift-cards/apple-gift-card/pcmcat748300439228.c",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.bestbuy.com/site/xbox/xbox-gift-card/pcmcat748300463093.c",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.bestbuy.com/site/playstation/psn-gift-card/pcmcat748300463089.c",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  // ── Target (green zone, authorized retailer) ──
  {
    sourceSlug: "target",
    sourceName: "Target",
    brandName: "Apple",
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.target.com/p/apple-gift-card/-/A-83898396",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    sourceName: "Target",
    brandName: "Nintendo",
    title: "Nintendo eShop Gift Card $50",
    faceValueCents: 5000,
    askingPriceCents: 5000,
    feeTotalCents: 0,
    currency: "USD",
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.target.com/p/nintendo-eshop-50-gift-card/-/A-75487781",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "25",
    countries: ["US"],
    externalUrl: "https://www.target.com/p/roblox-gift-card/-/A-77879977",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  // ── Newegg (green zone, authorized reseller) ──
  {
    sourceSlug: "newegg",
    sourceName: "Newegg",
    brandName: "Steam",
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.newegg.com/steam-gift-card-50/p/N82E16832234218",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "25",
    countries: ["US"],
    externalUrl: "https://www.newegg.com/xbox-live-25-gift-card/p/N82E16832268127",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  // ── Walmart (green zone, authorized retailer) ──
  {
    sourceSlug: "walmart",
    sourceName: "Walmart",
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.walmart.com/ip/Google-Play-50-Gift-Card/47047355",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "25",
    countries: ["US"],
    externalUrl: "https://www.walmart.com/ip/Xbox-25-Gift-Card/47052938",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "10",
    countries: ["US"],
    externalUrl: "https://www.walmart.com/ip/Roblox-10-Gift-Card/47007966",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  // ── GameStop (green zone, authorized retailer) ──
  {
    sourceSlug: "gamestop",
    sourceName: "GameStop",
    brandName: "PlayStation",
    ...
    denomination: "50",
    countries: ["US"],
    externalUrl: "https://www.gamestop.com/gift-cards/playstation",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "35",
    countries: ["US"],
    externalUrl: "https://www.gamestop.com/gift-cards/nintendo",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
  {
    ...
    denomination: "25",
    countries: ["US"],
    externalUrl: "https://www.gamestop.com/gift-cards/roblox",
    hasBuyerProtection: true,
    lastVerified: "2026-04-01",
  },
...
export const bestbuyCatalogAdapter = createCatalogAdapter("bestbuy", "Best Buy");
export const targetCatalogAdapter = createCatalogAdapter("target", "Target");
export const neweggCatalogAdapter = createCatalogAdapter("newegg", "Newegg");
export const walmartCatalogAdapter = createCatalogAdapter("walmart", "Walmart");
export const gamestopCatalogAdapter = createCatalogAdapter("gamestop", "GameStop");
