    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mb-10">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-surface-900 sm:text-4xl">
          Where We Find Your Deals
        </h1>
        <p className="mt-3 max-w-2xl text-base text-surface-500 leading-relaxed">
          Every source iGift monitors, ranked by trust score. We evaluate buyer protection, refund
          policies, and live data quality so you know exactly where a deal comes from.
        </p>
        ...
        <div className="mt-6 flex flex-wrap gap-4">
          <div className="flex items-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm">
            ...
            <span className="text-surface-500">Green Zone Sources</span>
          </div>
          <div className="flex items-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm">
            <span className="h-2 w-2 rounded-full bg-alert-500" />
            <span className="font-semibold text-surface-900">{yellowCount}</span>
            <span className="text-surface-500">Yellow Zone Sources</span>
          </div>
          <div className="flex items-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm">
            ...
            <span className="text-surface-500">Active Offers</span>
          </div>
          <div className="flex items-center gap-2 rounded-xl border border-surface-200 bg-white px-4 py-2.5 text-sm">
            ...
            <span className="text-surface-500">With Buyer Protection</span>
          </div>
        </div>
      </div>
      ...
      {greenCount > 0 && (
        <section className="mb-10">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-surface-900">Green Zone</h2>
      ...
      {yellowCount > 0 && (
        <section className="mb-10">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-surface-900">Yellow Zone</h2>
            <span className="rounded-full bg-alert-50 px-2 py-0.5 text-xs font-medium text-alert-700">
              Reputable Marketplaces — Verify Before Buying
            </span>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {ranked
      ...
      {ranked.length === 0 && (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-lg font-semibold text-surface-500">No sources found</p>
          <p className="mt-1 text-sm text-surface-400">
            The database has not been seeded yet. Run{" "}
      ...
      <div className="mt-8 rounded-2xl border border-brand-100 bg-brand-50 px-6 py-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-brand-900">How Trust Scores Work</h3>
            <p className="mt-1 text-sm text-brand-700 leading-relaxed">
              Each source is scored 0–100 across four dimensions: trust zone (40 pts), buyer
              protection availability (20 pts), refund policy presence (15 pts), and live fetch
              success rate (25 pts). Green Zone sources are official issuers or authorized
